      ...
      <>
        ...
        <Container style={{ height: '85vh' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: "center", marginTop: "0.6rem" }}>
            <Button onClick={() => setRedirectPath('/admin/games/addgame')} style={{ fontSize: fontSize * 0.8 }}>Add Game</Button>
          </div>
                              ...
                              <Card.Body>
                                <Form name="edit" >
                                  <Form.Group id="class">
                                    ...
                                    <br />
                                    <Form.Label style={{ fontSize: Math.max(fontSize * 0.8, 14) }}>{event[3]}</Form.Label>
                                    <br />
